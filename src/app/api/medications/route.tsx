...
export const POST = async (req: NextRequest) => {
  const filePath =
    "/Users/hongyun/Rocket/bootcamp/m4/capstone-project/medmx/public/IMG_1266.jpeg";
      ...
      for (const entity of entities) {
        switch (entity.type) {
          case "drug_name":
            ...
            break;
          case "dosing_instructions":
            extractedMedLabel.dosingInstructions =
              entity.mentionText?.toLocaleLowerCase() ?? "";
            break;
          case "auxiliary_instructions":
            extractedMedLabel.auxInstructions =
              entity.mentionText?.toLocaleLowerCase() ?? "";
            break;
        }
      }
